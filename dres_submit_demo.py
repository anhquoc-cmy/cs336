...
SESSION_ID: Optional[str] = "XlUTbMpEbTl1Mz3rWVqp838m5a0oJ-4d"                  # Điền thủ công nếu bạn có sẵn, VD: "abcd-efgh-1234"
USERNAME: Optional[str] = "<team013>"            # Dùng khi cần auto-login
PASSWORD: Optional[str] = "<123456>"            # Dùng khi cần auto-login
